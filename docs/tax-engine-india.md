...
- Models at `tax_engine/countries/in/models.py` allow mapping products to these codes with their respective GST rates.
...
### API Connections
Stubs for GSTN and IRP API interactions are available in `tax_engine/countries/in/gstn.py`.
