...
1. **Ireland Tax Engine (`tax_engine/countries/ie/__init__.py`)**
...
2. **PAYE / PRSI / USC (`tax_engine/countries/ie/paye.py`)**
...
7. **PDF Generators (`tax_engine/countries/ie/pdf_generators.py`)**
