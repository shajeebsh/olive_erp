...
from tax_engine.countries.ie import IrelandTaxEngine
from tax_engine.countries.ie.ct1 import CT1Calculator
from tax_engine.countries.ie.paye import PAYECalculator
